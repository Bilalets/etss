...
<option value="" disabled selected hidden>Select a Sub Product</option>
        <option value="product-1">FIA</option>
        <option value="product-2">CSS</option>
        <option value="product-3">PMS</option>
        <option value="product-3">ISSB</option>
      </select>
</div>
...
<div className="relative rounded-full overflow-hidden bg-white shadow-xl w-2/4">
  ...
  />
    ...
    <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mt-10 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Create Category</button>
